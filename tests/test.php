<?php
namespace Lindowx\FQuickHash\Tests;
...
class TestLogger implements \Psr\Log\LoggerInterface
{
    ...
    public function log($level, $message, array $context = array())
    {
        ...
        $msg = sprintf('%s [%s] %s', $level, $datetime, $message);
        echo $msg, PHP_EOL;
    }
}

$file_1 = '/mnt/i/karaoke_transcode/01-【歌手分类】/歌手01--数字开头/183CLUB/183CLUB-再一遍(MTV)-国语-流行歌曲.mp4';
